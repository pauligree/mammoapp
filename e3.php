    ...
    <div id="modal-tabella" class="mdl-dialog mdl-cell--9-col mdl-cell--9-col-tablet mdl-cell--9-col-desktop">
      ...
      <div class="mdl-dialog__content">
        <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
          ...
          <tbody>
            <tr>
              <td class="mdl-data-table__cell--non-numeric">Lo screening serve a far morire di tumore al seno meno donne? <br/>A questa domanda diversi gruppi di ricercatori hanno cercato di dare risposta ma sono arrivati a risultati diversi, con valori di riduzione della mortalità per tumore del seno che vanno dal 15% al 38%. Questi dati purtroppo non si possono confrontare tra di loro perché arrivano da studi diversi, su donne di età diversa, seguite per periodi diversi.Per questa ragione non c'è una sola risposta e se ne continua a discutere.
              </td>
              <td class="mdl-data-table__cell--non-numeric">Lo screening a quante sovradiagnosi porta?<br/>
                A questa domanda diversi gruppi di ricercatori hanno cercato di dare risposta ma sono arrivati a risultati diversi con valori di sovradiagnosi che vanno da circa il 5% al 30%. Questi dati purtroppo non si possono confrontare tra di loro perché arrivano da studi diversi, su donne di età diversa, seguite per periodi diversi. Per questa ragione non c'è una sola risposta e se ne continua a discutere.
              </td>
            </tr>
          </tbody>
        </table>
