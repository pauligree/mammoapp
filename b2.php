...
<head>
  ...
  <meta name="description" content="Come interpretare il risultato della mammografia
  ">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
  <title>Come interpretare il risultato della mammografia
  </title>
      ...
      <div class="mdl-grid demo-content">
        <div class="mdl-grid mdl-cell--10-col ">
          ...
          <div class="demo-crumbs mdl-color-text--grey-500">
            <a href="./">Inizio</a> | <a class="indietro" href="#">Indietro</a> &gt; Come interpretare il risultato della mammografia
          </div>
        </div>
        ...
        <div class="mdl-color--white- mdl-shadow--2dp- mdl-cell mdl-cell--12-col mdl-grid">
          ...
          <div class="mdl-shadow--2dp- mdl-cell mdl-cell--11-col mdl-grid">
            ...
            <div class="vai-a-container">
              ...
              <a class="button-vai-a mdl-button--colored mdl-button mdl-js-button mdl-js-ripple-effect mdl-cell--3-col mdl-button--raised mdl-color-text--white" href="b3.php">Cosa succede alle donne che si sottopongono al controllo?</a>
