...
<div class="banner"><img src="images/QB_progress-02-1.jpg"></div>
        ...
        <div class="mdl-color--white- mdl-shadow--2dp- mdl-cell mdl-cell--12-col mdl-grid">
          <div class="mdl-color--white- mdl-shadow--2dp- mdl-cell--9-col  mdl-grid">
            ...
            <p>Il tumore al seno dipende da <a href="c3.php">diversi fattori</a> (tra cui <a href="c3.php">l’età, la storia familiare e lo stile di vita</a>) ed è molto comune (vedi il <a href="#" class="gfx-c3-1">grafico 1</a>) ma ha <a href="c4.php">ottime probabilità di guarigione</a> (vedi il <a href="#" class="gfx-c3-2">grafico 2</a>).</p>
<p>Si può manifestare in diverse forme ed è dovuto alla moltiplicazione incontrollata di cellule della ghiandola mammaria che si sono trasformate in cellule maligne. Le cellule tumorali possono crescere ( se restano nel seno si parla di tumore in situ) e col tempo anche migrare in altri organi a distanza, formando le cosiddette metastasi. Un tumore con metastasi è più difficile da combattere: per questo è importante intervenire per tempo.</p>
<p>Alla maggior parte delle donne con diagnosi di tumore del seno viene consigliato un trattamento chirurgico con cui viene asportato solo il tumore, insieme al tessuto circostante, o l’intero seno, secondo quanto è estesa la malattia. Altri trattamenti possibili, in aggiunta e in diverse sequenze, sono la radioterapia o la chemioterapia o la terapia ormonale, che si sono dimostrati utili per ridurre la possibilità che la malattia si ripresenti.</p>
