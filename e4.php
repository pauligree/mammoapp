...
<head>
  ...
  <meta name="description" content="Confronto tra i diversi valori di mortalità specifica">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
  <title>Confronto tra i diversi valori di mortalità specifica</title>
      ...
      <div class="mdl-grid demo-content">
        <div class="mdl-grid mdl-cell--10-col ">
          ...
          <div class="demo-crumbs mdl-color-text--grey-500">
            <a href="./">Inizio</a> | <a class="indietro" href="#">Indietro</a> &gt; Confronto tra i diversi valori di mortalità specifica
          </div>
        </div>
