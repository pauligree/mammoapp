...
<head>
  ...
  <meta name="description" content="Confronto tra i diversi valori di sovradiagnosi">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
  <title>Confronto tra i diversi valori di sovradiagnosi</title>
      ...
      <div class="mdl-grid demo-content">
        <div class="mdl-grid mdl-cell--10-col ">
          ...
          <div class="demo-crumbs mdl-color-text--grey-500">
            <a href="./">Inizio</a> | <a class="indietro" href="#">Indietro</a> &gt; Confronto tra i diversi valori di sovradiagnosi
          </div>
        </div>
...
La grossa differenza tra le ultime due stime (Cochrane review, UK Panel) è dovuta soprattutto alla diversa scelta degli studi sperimentali inseriti nelle revisioni e alla diversa lunghezza dell’osservazione successiva al periodo di screening (<a href="#" class="open-modal-fonti">vedi le fonti</a>).</p>
          ...
          <div class="mdl-shadow--2dp- mdl-cell mdl-cell--11-col mdl-grid">
            ...
            <div class="vai-a-container">
              ...
              <a class="button-vai-a mdl-button--colored mdl-button mdl-js-button mdl-js-ripple-effect mdl-cell--3-col mdl-button--raised mdl-color-text--white" href="e4.php">Confronto tra i diversi valori di mortalità specifica</a>
