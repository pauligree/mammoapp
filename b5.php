...
<div class="banner"><img src="images/QB_progress-02-1.jpg"></div>
        ...
        <div class="mdl-color--white- mdl-shadow--2dp- mdl-cell mdl-cell--12-col mdl-grid">
          <div class="mdl-color--white- mdl-shadow--2dp- mdl-cell--9-col  mdl-grid">
            ...
            <p>La mammella è composta da una parte ghiandolare e una parte adiposa (grasso). Quando la parte adiposa è molto rappresentata l’aspetto alla mammografia è chiaro. Al contrario quando vi è una discreta componente ghiandolare l’aspetto è più denso.</p>
<p>Il seno denso rende meno leggibile la mammografia e può mascherare la presenza di un tumore, dando un risultato falsamente “negativo”.</p>
<p>Di solito la densità si modifica nel tempo perché con l’aumentare dell’età la parte ghiandolare diminuisce. Questo spiega perché, in genere, la mammografia delle donne di età più avanzata ha un aspetto più nitido.</p>
