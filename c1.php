...
<head>
  ...
  <meta name="description" content="Che cosa è e come si cura il tumore al seno">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
  <title>Che cosa è e come si cura il tumore al seno</title>
  ...
  <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer- mdl-layout--fixed-header">
    <header class="demo-header mdl-layout__header">
      <div class="mdl-layout__header-row">
        ...
        <a id="gfx-c3-1" href="#" class="gfx-c3-1 mdl-color-text--white"><i class="material-icons mdl-24">poll</i></a>
        <a id="gfx-c3-2" href="#" class="gfx-c3-2 mdl-color-text--white"><i class="material-icons mdl-24">poll</i></a>
      ...
      <div class="mdl-grid demo-content">
        <div class="mdl-grid mdl-cell--10-col ">
          ...
          <div class="demo-crumbs mdl-color-text--grey-500">
            <a href="./">Inizio</a> | <a class="indietro" href="#">Indietro</a> &gt; Che cosa è e come si cura il tumore al seno
          </div>
        </div>
        ...
        <div class="mdl-shadow--2dp- mdl-cell mdl-cell--11-col mdl-grid">
          ...
          <div class="vai-a-container">
            ...
            <a class="button-vai-a mdl-button--colored mdl-button mdl-js-button mdl-js-ripple-effect mdl-cell--3-col mdl-button--raised mdl-color-text--white" href="c3.php">I principali fattori di rischio e di protezione dal tumore</a>
  ...
  <div class="hide-modal">
    ...
    <div id="modal-glossario" class="mdl-dialog mdl-cell--11-col mdl-cell--11-col-tablet mdl-cell--11-col-desktop">
      ...
      <div class="mdl-dialog__content">
        ...
        <br/>Le persone con sindrome metabolica hanno un aumento del rischio di malattie cardiovascolari e di alcune forme tumorali.<br/><br/>
