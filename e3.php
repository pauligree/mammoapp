...
<li>IARC Handbooks of Cancer Prevention. Breast cancer screening. IARC, n. 7, Lyon, 2002.</li>
<li>EUROSCREEN Working Group. J Med Screen 2012;19(Suppl1).</li>
<li>Independent UK Panel on breast cancer screening. The benefits and harms of breast cancer screening: an independent review. Lancet 2012;380:1778-86.</li>
...
<p><strong>Terapia ormonale sostitutiva (TOS o HRT, Hormone Replacement Therapy)</strong> Somministrazione di ormoni femminili (estrogeni e/o progestinici) quando, con la menopausa o per un intervento chirurgico, &egrave; cessata la funzione ovarica.</p>
          ...
          <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
            <thead>
              <tr class="testata-tabella">
                <th class="mdl-data-table__cell--non-numeric">Lo screening serve a far morire di tumore al seno meno donne?</th>
                <th class="mdl-data-table__cell--non-numeric">Lo screening a quante sovradiagnosi porta?</th>
              </tr>
            </thead>
            <tbody>
              <tr>
      ...
      <script type="text/javascript">
        $( document ).ready(function() {
          ...
          var tabella = $('#modal-tabella').html();  
          ...
          $('.open-modal-tabella').click(function () {
            showDialog({
              text: tabella,
              positive: {
                title: 'Chiudi'
