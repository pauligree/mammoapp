...
<head>
  ...
  <meta name="description" content="I principali fattori di rischio e di protezione dal tumore">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
  <title>I principali fattori di rischio e di protezione dal tumore</title>
      ...
      <div class="mdl-grid demo-content">
        <div class="mdl-grid mdl-cell--10-col ">
          ...
          <div class="demo-crumbs mdl-color-text--grey-500">
            <a href="./">Inizio</a> | <a class="indietro" href="#">Indietro</a> &gt; I principali fattori di rischio e di protezione dal tumore
          </div>
        </div>
