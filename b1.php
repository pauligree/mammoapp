...
<head>
  ...
  <meta name="description" content="Lo screening mammografico organizzato, un programma di qualità">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
  <title>Lo Screening mammografico organizzato, un programma di qualità</title>
...
<body>
      ...
      <div class="mdl-grid demo-content">
        <div class="mdl-grid mdl-cell--10-col ">
          ...
          <div class="demo-crumbs mdl-color-text--grey-500">
            <a href="./">Inizio</a> | <a class="indietro" href="#">Indietro</a> &gt; Lo Screening mammografico organizzato
          </div>
        </div>
  ...
  <div class="mdl-tooltip mdl-tooltip--large mdl-tooltip--top" data-mdl-for="mammografia"> </div> 
  ...
  <div class="hide-modal">
    ...
    <div id="modal-fonti" class="mdl-dialog mdl-cell--11-col mdl-cell--11-col-tablet mdl-cell--11-col-desktop">
      ...
      <div class="mdl-dialog__content">
       <p><ul>
        <li>Osservatorio Nazionale Screening. Undicesimo rapporto<strong>, </strong>2015. [<a href="http://www.gisma.it/documenti/pubblicazioni/ONS_2015_full.pdf" target="_blank">link</a>]</li>
      </ul></p>
    </div>
  </div>
